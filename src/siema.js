...
var Siema = /** @class */ (function () {
     ...
     */
    Siema.mergeSettings = function (options) {
        var settings = {
            selector: ".siema",
            duration: 200,
            easing: "ease-out",
        ...
        return __assign(__assign({}, settings), options);
    };
    /**
     ...
     */
    Siema.prototype.attachEvents = function () {
     ...
     */
    Siema.prototype.detachEvents = function () {
     ...
     */
    Siema.prototype.resolveSlidesNumber = function () {
     ...
     */
    Siema.prototype.prev = function (howManySlides, callback) {
        if (howManySlides === void 0) { howManySlides = 1; }
        ...
        if (this.config.loop) {
            ...
            if (isNewIndexClone) {
                ...
                var moveTo_1 = mirrorSlideIndex + mirrorSlideIndexOffset;
                var offset = (this.config.rtl ? 1 : -1) *
                    moveTo_1 *
     ...
     * @param {function} callback - Optional callback function.
     */
    Siema.prototype.next = function (howManySlides, callback) {
        if (howManySlides === void 0) { howManySlides = 1; }
        // early return when there is nothing to slide
        if (this.innerElements.length <= this.perPage) {
            return;
        ...
        var beforeChange = this.currentSlide;
        if (this.config.loop) {
            var isNewIndexClone = this.currentSlide + howManySlides >
                this.innerElements.length - this.perPage;
            if (isNewIndexClone) {
                this.disableTransition();
                var mirrorSlideIndex = this.currentSlide - this.innerElements.length;
                var mirrorSlideIndexOffset = this.perPage;
                var moveTo_2 = mirrorSlideIndex + mirrorSlideIndexOffset;
                var offset = (this.config.rtl ? 1 : -1) *
                    moveTo_2 *
                    (this.selectorWidth / this.perPage);
                var dragDistance = this.config.draggable
     ...
     */
    Siema.prototype.disableTransition = function () {
     ...
     */
    Siema.prototype.enableTransition = function () {
     ...
     * @param {function} callback - Optional callback function.
     */
    Siema.prototype.goTo = function (index, callback) {
        if (this.innerElements.length <= this.perPage) {
            return;
        }
        var beforeChange = this.currentSlide;
     ...
     */
    Siema.prototype.updateAfterDrag = function () {
        ...
        var slideToPositiveClone = movement < 0 &&
     ...
     */
    Siema.prototype.resizeHandler = function () {
        // update perPage number dependable of user value
        this.resolveSlidesNumber();
     ...
     */
    Siema.prototype.clearDrag = function () {
        this.drag = {
            startX: 0,
            endX: 0,
            startY: 0,
     ...
     */
    Siema.prototype.touchstartHandler = function (e) {
        // Prevent dragging / swiping on inputs, selects and textareas
        var ignoreSiema = ["TEXTAREA", "OPTION", "INPUT", "SELECT"].indexOf(e.target.nodeName) !==
            -1;
        if (ignoreSiema) {
            return;
        }
     ...
     */
    Siema.prototype.touchendHandler = function (e) {
        e.stopPropagation();
        this.pointerDown = false;
        this.enableTransition();
        if (this.drag.endX) {
     ...
     */
    Siema.prototype.mousedownHandler = function (e) {
        // Prevent dragging / swiping on inputs, selects and textareas
        var ignoreSiema = ["TEXTAREA", "OPTION", "INPUT", "SELECT"].indexOf(e.target.nodeName) !==
            -1;
        if (ignoreSiema) {
     ...
     */
    Siema.prototype.mouseupHandler = function (e) {
        e.stopPropagation();
        this.pointerDown = false;
        this.selector.style.cursor = "-webkit-grab";
        this.enableTransition();
     ...
     */
    Siema.prototype.mouseleaveHandler = function (e) {
        if (this.pointerDown) {
            this.pointerDown = false;
            this.selector.style.cursor = "-webkit-grab";
            this.drag.endX = e.pageX;
     ...
     * click event handler
     */
    Siema.prototype.clickHandler = function (e) {
     ...
     */
    Siema.prototype.remove = function (index, callback) {
     ...
     */
    Siema.prototype.insert = function (item, index, callback) {
     ...
     */
    Siema.prototype.prepend = function (item, callback) {
        this.insert(item, 0);
        if (callback) {
            callback.call(this);
        }
     ...
     * @param {function} callback - Optional callback function.
     */
    Siema.prototype.destroy = function (restoreMarkup, callback) {
